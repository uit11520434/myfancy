<?php /* Smarty version 2.6.6, created on 2014-02-25 13:46:32
         compiled from post.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'get_advertisement', 'post.tpl', 124, false),)), $this); ?>
...
/submit?t=v"><?php echo $this->_tpl_vars['lang101']; ?>
					...
					<li class="tab_blog current"><a class="blog" href="<?php echo $this->_tpl_vars['baseurl']; ?>
/post">Chém gió</a></li>
					<li class="tab_tamsu"><a class="blog" href="<?php echo $this->_tpl_vars['baseurl']; ?>
...
/post" enctype="multipart/form-data" method="post">
                    ...
                    <h3>Đăng bài: truyện cười, chém gió, thơ vui</h3>
                    <div class="field">
                        <label>
...
echo smarty_core_run_insert_handler(array('args' => array('name' => 'get_advertisement', 'value' => 'var', 'AID' => '2')), $this); ?>

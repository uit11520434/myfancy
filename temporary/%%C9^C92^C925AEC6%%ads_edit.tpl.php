<?php /* Smarty version 2.6.6, created on 2014-04-09 04:21:54
...
" class=" required-entry required-entry input-text" type="text"/>
                                                	...
                                                	<tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                        	<textarea id="code" name="code" class=" textarea" type="textarea" ><?php echo ((is_array($_tmp=$this->_tpl_vars['ad']['code'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</textarea>
                                                        </td>

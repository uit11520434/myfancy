<?php /* Smarty version 2.6.6, created on 2014-04-09 06:49:16
         compiled from posts_bit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'makeseo', 'posts_bit.tpl', 1, false),array('modifier', 'stripslashes', 'posts_bit.tpl', 1, false),array('modifier', 'mb_truncate', 'posts_bit.tpl', 1, false),array('modifier', 'strip_mq_gpc', 'posts_bit.tpl', 16, false),array('modifier', 'smiley', 'posts_bit.tpl', 53, false),array('modifier', 'fullname', 'posts_bit.tpl', 60, false),array('modifier', 'tagsexplode', 'posts_bit.tpl', 109, false),array('insert', 'get_user_likes', 'posts_bit.tpl', 55, false),array('insert', 'get_member_profilepicture', 'posts_bit.tpl', 56, false),array('insert', 'get_time_to_days_ago', 'posts_bit.tpl', 57, false),array('insert', 'get_user_level', 'posts_bit.tpl', 61, false),array('insert', 'get_fav_count', 'posts_bit.tpl', 78, false),)), $this); ?>
...
/images/play.png"></img></a>
                                        ...
                                        <?php elseif ($this->_tpl_vars['posts'][$this->_sections['i']['index']]['contents'] != ""):  echo ((is_array($_tmp=$this->_tpl_vars['posts'][$this->_sections['i']['index']]['contents'])) ? $this->_run_mod_handler('strip_mq_gpc', true, $_tmp) : strip_mq_gpc($_tmp)); ?>
										                                                                                          ...
										                                                                                          <?php else: ?>										<a target="_blank" href="<?php echo $this->_tpl_vars['baseurl'];  echo $this->_tpl_vars['postfolder'];  echo $this->_tpl_vars['posts'][$this->_sections['i']['index']]['PID']; ?>
/<?php if ($this->_tpl_vars['SEO'] == '1'):  echo ((is_array($_tmp=$this->_tpl_vars['posts'][$this->_sections['i']['index']]['story'])) ? $this->_run_mod_handler('makeseo', true, $_tmp) : smarty_modifier_makeseo($_tmp)); ?>
